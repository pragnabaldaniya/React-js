...
module.exports.changePassword = async (req, res) => {
    try {
        ...
        const user = await userAuthService.fetchSingleUser({ _id: req.user.id || req.user._id }, false);
        ...
        await userAuthService.updateUser(req.user.id || req.user._id, { password: req.body.new_password });
